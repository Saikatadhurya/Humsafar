...
.zoompic:hover{  -ms-transform: scale(1.1); /* IE 9 */
...
.zoom:hover {
  ...
  transform: scale(1.1); 
	...
	.col-md-6 li::before {content: "•"; color: #FFCC00;
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="materialize Material" data-description="">
                        ...
                        <div class="tp-caption rev-subheading tp-resizeme"
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 5; color: #464646; font-weight: 600; font-family: inherit;">Best worldwide car sharing deals!!!!!
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                            ...
                            <a href="#download" class="button black-button slider-button" data-fontsize="['22','22','22','22']">Download Now</a>
                        </div>
                    ...
                    <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="materialize Material" data-description="">
                        ...
                        <div class="tp-caption tp-resizeme rev-subheading"
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 5; color: #464646; font-weight: 600; font-family: inherit;">Share Your Ride with Humsafar
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme rev-subheading"
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 6; color: #e91e22; font-family: 'Exo', sans-serif; font-weight: 800;">Share a Ride?
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme NotGeneric-Title"
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 7; color: #000000; font-family: 'Exo', sans-serif; font-weight: 900; text-transform: uppercase;">Share your<br> own Car
                        </div>
                        ...
                        <div class="tp-caption rev-subheading tp-resizeme"
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 5; color: #464646; font-weight: 600; font-family: inherit;">Best worldwide car sharing App!!!!!
                        </div>
     ...
     <div class="about-main-content mr-top-90">
        <div class="container" style="margin-bottom:10px;">
            <div class="row">
                <div class="col-md-12">
                    <div class="about-top-content">
                        <div class="row">
                            <div class="col-md-12">
							<div class="heading-content style-one border" style="box-shadow: 10px 10px 5px grey;padding:15px;">
                ...
                <div class="col-md-12">
                    <div class="about-top-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="assets/images/about/mnh.jpg" class="zoom" title=" Best Car renting and car sharing services." alt="car-item" style="border-radius:10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"/>
                            </div><!-- /.col-md-7 -->
							<br>
							<div class="col-md-6">
                                <div class="about-content-right" style="border:1px solid; border-color:#FFCC00; border-radius: 5px;  box-shadow: 10px 10px 5px grey;">
								 <div style="margin:8px;">			
									 <h2 class="title" ><strong><span style="color:#ffcc00" >How to use Humsafar?</span></strong></h2>
									 <hr>
								  <ul>
									<li>At first the user will open Humsafar platform and select his mode ,either driver or rider.</li>

									<li>If the user signs in as rider  he has to select start point and end point.</li>
			...
			<div class="row">
                           <br>
                            <div class="col-md-6">
                                <div class="about-content-left" style="border:1px solid; border-color:#FFCC00; border-radius: 5px;  box-shadow: 10px 10px 5px grey;">
                                    <div style="margin:8px;">
									<h2 class="title"><strong><span style="color:#ffcc00">Why you use HUMSAFAR?</span></strong></h2>
									<hr>
									<ul>
									<li>Humsafar will reduce traffic on the roads.</li>

									<li>It will also maximise resource utilization.</li>

									<li>It will give an option to the car owner to earn money while travelling to his destination.</li>
									<li>The apps are developed in such a way that users from any country and any state can post journey details.</li>
									<li>We can easily scale to anywhere in the globe because the only thing that is required is their Area name and zipcode.</li>
                            ...
                            <div class="col-md-6" style="float:right;">
                                <img src="assets/images/about/mnb.jpg" class="zoom" title="Best Car renting and car sharing services."  alt="car-item" style="border-radius:10px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"/>
                            </div><!-- /.col-md-7 -->
